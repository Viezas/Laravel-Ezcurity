<div class="py-5">
  ...
  <div class="flex flex-wrap items-center justify-center px-4 md:px-10 lg:px-0">
    ...
    <!-- Videosurveillance -->
    <div class="border-2 border-gray-400 py-6 px-7 flex items-center justify-center flex-wrap mb-10 md:px-20 lg:w-2/5 lg:mr-10 lg:h-96 lg:px-8">
      ...
      <a href="/" class="border border-gray-600 px-5 text-xl hover:bg-blue-600 hover:text-white">Consulter les offres</a>
    </div>

    <!-- Alarmes -->
    <div class="border-2 border-gray-400 py-6 px-7 flex items-center justify-center flex-wrap mb-10 md:px-20 lg:w-2/5 lg:h-96 lg:px-8">
